...
//////////////// Smoothscroll
mr=function(n,i,r,t){"use strict";return n.smoothscroll=n.smoothscroll||{},n.smoothscroll.sections=[],n.smoothscroll.init=function(){n.smoothscroll.sections=[],i("a.inner-link").each(function(){var t={},e=i(this),a=e.attr("href"),o;new RegExp("^#[^\r\n\t\f\v#.]+$","gm").test(a)&&i("section"+a).length&&(t.id=a,t.top=Math.round(i(a).offset().top),t.height=Math.round(i(a).outerHeight()),t.link=e.get(0),t.active=!1,n.smoothscroll.sections.push(t))}),n.smoothscroll.highlight()},n.smoothscroll.highlight=function(){n.smoothscroll.sections.forEach(function(t){n.scroll.y>=t.top&&n.scroll.y<t.top+t.height?!1===t.active&&(t.link.classList.add("inner-link--active"),t.active=!0):(t.link.classList.remove("inner-link--active"),t.active=!1)})},n.scroll.listeners.push(n.smoothscroll.highlight),n.smoothscroll.documentReady=function(o){
// Smooth scroll to inner links
var t=o("a.inner-link"),e,a,i={};a={selector:".inner-link",selectorHeader:null,speed:750,easing:"easeInOutCubic",offset:0},t.length&&(t.each(function(t){var e=o(this),a;"#"!==e.attr("href").charAt(0)&&e.removeClass("inner-link")}),n.smoothscroll.init(),o(r).on("resize",n.smoothscroll.init),e=0,o("body[data-smooth-scroll-offset]").length&&(e=o("body").attr("data-smooth-scroll-offset"),e*=1),i.offset=0!==e?e:void 0,smoothScroll.init(jQuery.extend({},a,n.smoothscroll.options,i)))},n.components.documentReady.push(n.smoothscroll.documentReady),n.components.windowLoad.push(n.smoothscroll.init),n}(mr,jQuery,window,document),
//////////////// Tabs
